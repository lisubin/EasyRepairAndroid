...
import com.repair.lsb.easyrepair.utils.ScreenUtils;
...
public abstract class BaseActivity extends AppCompatActivity implements View.OnClickListener {
  ...
  //  public G viewBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScreenUtils.setfullscreen(getWindow(),false);
...
//    }
    ...
    public final String getContent(EditText context){
        return context.getText().toString().trim();
    }
